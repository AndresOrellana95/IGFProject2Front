...
@Component({
  templateUrl: './finalistas-candidatos.component.html',
  styleUrls: [ './proceso-candidato.component.css' ]
})

export class componenteFinalistas implements OnInit{
  ...
  abrirInscripcion(candidato: Candidato) {
    window.location.href="./finalistas/"+candidato.id
  }
